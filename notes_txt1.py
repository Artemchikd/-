...
from PyQt5.QtWidgets import QApplication, QWidget, QHBoxLayout,QVBoxLayout, QPushButton, QLabel, QListWidget, QLineEdit, QTextEdit, QInputDialog, QFormLayout, QListWidgetItem
import json
...
field_tag = QLineEdit('')
field_tag.setPlacehoIderText('Введите тег')
